    ...
    return (
        <div className="space-y-6">
            <div>
                ...
                <p className="text-muted-foreground">Contenido exclusivo para tus servicios contratados.</p>
            </div>
            {availableServices.length > 0 ? (
                ...
                <Card className="text-center py-16">
                    <CardContent>
                        <h3 className="font-semibold mb-2">No tienes servicios activos</h3>
                        <p className="text-muted-foreground">Contrata un servicio para acceder a contenido exclusivo.</p>
                    </CardContent>
                </Card>
            )}
        </div>
