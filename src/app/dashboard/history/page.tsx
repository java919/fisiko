  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">Registro de todas tus sesiones completadas en FISIKO.</p>
      </div>
      <Card>
          ...
          <Table>
            ...
            <TableBody>
              {userSessions.length > 0 ? userSessions.map(session => {
                ...
                <TableRow>
                  <TableCell colSpan={3} className="text-center h-24 text-muted-foreground">Aún no has completado ninguna sesión.</TableCell>
                </TableRow>
              )}
            </TableBody>
          </Table>
