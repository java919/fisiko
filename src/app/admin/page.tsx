  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col gap-1">
        <h1 className="font-headline text-2xl md:text-3xl font-bold text-primary tracking-tight">Panel de Administración FISIKO</h1>
        <p className="text-sm text-muted-foreground">Resumen general de tu actividad y próximos eventos.</p>
      </div>
            ...
            <CardContent>
                <div className="space-y-4">
                    {sessions.slice(0, 3).map(session => {
                        ...
                        return (
                            <div key={session.id} className="flex flex-col border-b last:border-0 pb-3 last:pb-0">
            ...
            <CardContent>
                <div className="space-y-4">
                    {calendarSlots.filter(s => s.isBooked && s.startTime > now).slice(0, 3).map(slot => {
                        ...
                        return (
                            <div key={slot.id} className="flex flex-col border-b last:border-0 pb-3 last:pb-0">
                                <p className="text-sm font-bold truncate">{client?.name}</p>
                                <p className="text-xs text-muted-foreground">
